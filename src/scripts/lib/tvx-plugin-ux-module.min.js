...
};this.createIFrame=function(ag,ah){return a.strReplace(a.strReplace(o.COMMON.HTML.IFRAME,"{CLASS}",a.htmlAttrEscape(ag)),"{SRC}",a.htmlAttrEscape(a.strFullCheck(ah,"about:blank")))};this.isReady=function(){return !V.isBusy()};this.onReady=function(ag){V.onReady(ag)};this.startInitService=function(){V.start()};this.stopInitService=function(){V.stop()};this.areSettingsValidated=function(){return ac};this.invalidateSettings=function(){ac=false;Y=null};this.validateSettings=function(ao){ac=true;Y=ao;var ax=null;var aj=null;var aA=null;var aB=null;var aq=null;var aJ=null;var aI=null;var ay=null;var aE=null;var ak=null;var ag=null;var am=null;var aF=null;var ar=null;var ap=null;var au=null;var aC=null;var aG=null;var ai=null;var az=null;var ah=null;var av=null;var at=null;var aw=null;var an=null;var al=null;var aH=null;var aD=null;if(ao!=null&&ao.info!=null){aI=ao.info.platform;ay=ao.info.id;if(ao.info.time!=null){ax=ao.info.time.offset;aj=ao.info.time.zoneOffset}if(ao.info.screen!=null){aA=ao.info.screen.width;
aB=ao.info.screen.height;aq=ao.info.screen.factor;aJ=ao.info.screen.zoomFactor}if(ao.info.framework!=null&&ao.info.framework.settings!=null){aE=ao.info.framework.settings.animate;ak=ao.info.framework.settings.transform;ag=ao.info.framework.settings.input;am=ao.info.framework.settings.remote;aF=ao.info.framework.settings.layout;ar=ao.info.framework.settings.scale;ap=ao.info.framework.settings.zoom;au=ao.info.framework.settings.center;aC=ao.info.framework.settings.background;aG=ao.info.framework.settings.leave;ai=ao.info.framework.settings.exit;az=ao.info.framework.settings.back;ah=ao.info.framework.settings.volume;av=ao.info.framework.settings.busy;at=ao.info.framework.settings.speed;aw=ao.info.framework.settings.playback;an=ao.info.framework.settings.fullscreen;al=ao.info.framework.settings.suspend;aH=ao.info.framework.settings.secure;aD=ao.info.framework.settings.caption}}n.TIME_OFFSET=a.strToNum(ax,n.TIME_OFFSET);n.TIME_ZONE_OFFSET=a.strToNum(aj,n.TIME_ZONE_OFFSET);n.SCREEN_WIDTH=a.strToNum(aA,n.SCREEN_WIDTH);
n.SCREEN_HEIGHT=a.strToNum(aB,n.SCREEN_HEIGHT);n.SCREEN_FACTOR=a.strToNum(aq,n.SCREEN_FACTOR);n.ZOOM_FACTOR=a.strToNum(aJ,n.ZOOM_FACTOR);n.PLATFORM=a.strFullCheck(aI,n.PLATFORM);n.ID=a.strFullCheck(ay,n.ID);n.ANIMATE=a.strToNum(aE,n.ANIMATE);n.TRANSFORM=a.strToNum(ak,n.TRANSFORM);n.INPUT=a.strToNum(ag,n.INPUT);n.REMOTE=a.strToNum(am,n.REMOTE);n.LAYOUT=a.strFullCheck(aF,n.LAYOUT);n.SCALE=a.strFullCheck(ar,n.SCALE);n.ZOOM=a.strFullCheck(ap,n.ZOOM);n.CENTER=a.strToNum(au,n.CENTER);n.BACKGROUND=a.strToNum(aC,n.BACKGROUND);n.LEAVE=a.strToNum(aG,n.LEAVE);n.EXIT=a.strToNum(ai,n.EXIT);n.BACK=a.strToNum(az,n.BACK);n.VOLUME=a.strToNum(ah,n.VOLUME);n.BUSY=a.strToNum(av,n.BUSY);n.SPEED=a.strToNum(at,n.SPEED);n.PLAYBACK=a.strToNum(aw,n.PLAYBACK);n.FULLSCREEN=a.strToNum(an,n.FULLSCREEN);n.SUSPEND=a.strToNum(al,n.SUSPEND);n.SECURE=a.strToNum(aH,n.SECURE);n.CAPTION=a.strToNum(aD,n.CAPTION);ab(ao)};this.onValidatedSettings=function(ag){if(typeof ag=="function"){if(ac){ag(Y)}else{U(ag)}}};this.handleSettingsEvent=function(ah){if(ah!=null&&a.isFullStr(ah.event)&&ah.event.indexOf("settings:")==0){var ag=ah.event.substr(9);
if(ag=="animate"){n.ANIMATE=a.strToNum(ah.value,n.ANIMATE)}else{if(ag=="transform"){n.TRANSFORM=a.strToNum(ah.value,n.TRANSFORM)}else{if(ag=="input"){n.INPUT=a.strToNum(ah.value,n.INPUT)}else{if(ag=="remote"){n.REMOTE=a.strToNum(ah.value,n.REMOTE)}else{if(ag=="layout"){n.LAYOUT=a.strToNum(ah.value,n.LAYOUT)}else{if(ag=="scale"){n.SCALE=a.strFullCheck(ah.value,n.SCALE)}else{if(ag=="zoom"){n.ZOOM=a.strFullCheck(ah.value,n.ZOOM)}}}}}}}}};this.getFrameworkInfo=function(ag){return a.strFullCheck(W(ag),"-")+" "+a.strFullCheck(X(ag),"-")};this.getApplicationInfo=function(ag){return a.strFullCheck(T(ag),"-")+" "+a.strFullCheck(aa(ag),"-")};this.getContentInfo=function(ag){return a.strFullCheck(S(ag),"-")+" "+a.strFullCheck(ae(ag),"-")};this.checkFramework=function(ai,ah,ag){return a.checkVersion(X(ai),ah)&&Z(W(ai),ag)};this.checkApplication=function(ai,ah,ag){return a.checkVersion(aa(ai),ah)&&Z(T(ai),ag)};this.checkContent=function(ai,ah,ag){return a.checkVersion(ae(ai),ah)&&Z(S(ai),ag)};this.isSameContentState=function(ah,ag){return ah!=null&&ag!=null&&ah.start===ag.start&&ah.restored===ag.restored&&ah.menuId===ag.menuId&&ah.menuFlag===ag.menuFlag&&ah.menuFocus===ag.menuFocus&&ah.menuIndex===ag.menuIndex&&ah.menuSize===ag.menuSize&&ah.contentId===ag.contentId&&ah.contentFlag===ag.contentFlag&&ah.contentFocus===ag.contentFocus&&ah.contentIndex===ag.contentIndex&&ah.contentSize===ag.contentSize&&ah.contentVisible===ag.contentVisible&&ah.panelId===ag.panelId&&ah.panelFlag===ag.panelFlag&&ah.panelFocus===ag.panelFocus&&ah.panelIndex===ag.panelIndex&&ah.panelSize===ag.panelSize&&ah.panelVisible===ag.panelVisible&&ah.videoVisible===ag.videoVisible&&ah.videoActive===ag.videoActive&&ah.playerVisible===ag.playerVisible&&ah.slideshowVisible===ag.slideshowVisible&&ah.volumeVisible===ag.volumeVisible&&ah.logVisible===ag.logVisible
